                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="line1" value="" placeholder="Street at apartment number1" wire:model="line1">
                                    @error('line1') <span class="text-danger">{{ $message }}</span>@enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="add">Address:</label>
                                    <input type="text" name="line2" value="" placeholder="Street at apartment number2" wire:model="line2">
                            ...
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        ...
                                        <input type="text" name="line1" value="" placeholder="Street at apartment number1" wire:model="s_line1">
                                        @error('s_line1') <span class="text-danger">{{ $message }}</span>@enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="add">Line 2:</label>
                                        <input type="text" name="line2" value="" placeholder="Street at apartment number2" wire:model="s_line2">
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        @if(Session::has('checkout'))
                            <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">${{ session('checkout')['total'] }}</span></p>
                        @endif
                        {{-- submit checkout btn --}}
                        {{-- @php dd(Cart::instance('cart')->content()) @endphp --}}
