                ...
                <div class="panel-body">
                    ...
                    <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateSlide">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="file" placeholder="Image" class="input-file" wire:model="new_image">
                                {{-- see the image after upload before sub,it the form --}}
                                @if($new_image)
                                    <img src="{{ $new_image->temporaryUrl() }}" width="120" style="margin: 10px;" />
                                @else
                                    <img src="{{ asset('assets/images/sliders')}}/{{$image}}" width="120" style="margin: 10px;" />
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
