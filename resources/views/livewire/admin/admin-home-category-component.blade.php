                    ...
                    <div class="panel-body">
                        ...
                        <form  class="form-horizontal" wire:submit.prevent="updateHomeCategory">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="number" class="form-control input-md" wire:model="no_of_products" >
                                </div>
                            </div>
                            <div class="form-group">
...
{{-- assign data from select2 to the model "selected_categories" in "AdminHomeCategoryComponent" --}}
@push('scripts')
    <script>
